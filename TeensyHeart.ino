...
//
#define sclk 32  // SCLK can also use pin 14
#define mosi 0  // MOSI can also use pin 7
#define cs   2  // CS & DC can use pins 2, 6, 9, 10, 15, 20, 21, 22, 23
#define dc   4   //  but certain pairs must NOT be used: 2+10, 6+9, 20+23, 21+22
#define rst  3   // RST can use any pin
#define sdcs 5   // CS for SD card, can use any pin
...
#define B 0x6C3F // Blue (sky)
#define G 0x04BE // Gray (cloud shadow, alt blue really)
 
// First byte is height of tile in pixels.
 
const uint16_t PROGMEM
 tile_a[] = {  // Left cloud tile
...
void drawacloud() {
  for (int x = 0; x < 5; x++) {
    for (int y = 0; y < 8; y++) {
      tft.drawBuffer(x*24 + xoffset, y*16 + yoffset, 24, 16, (uint16_t*)tile_a);
    }
  }
